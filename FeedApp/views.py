...
def friends(request):
    ...
    #if this is the first time to access the friend req page, create the first relationship
    ...
    #check to see which submit button was pressed (sending a frienf request or accpeting a friend request)
